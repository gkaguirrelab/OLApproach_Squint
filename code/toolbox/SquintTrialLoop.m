    ...
    if protocolParams.simulate.udp
        ...
        for ss = 1:numSatellites
            ...
            configPacketFromBaseToSatellite = UDPobj.makePacket(...
                ...
                'experimentName', protocolParams.experimentName, ...
...
if any(strcmp('satellite',protocolParams.myRoles))
    ...
    if any(cellfun(@(x) sum(strcmp(x,'pupil')), protocolParams.myActions))
        ...
        pupilVideoSaveDirectoryPath = fullfile(getpref(protocolParams.protocol, 'DataFilesBasePath'),protocolParams.observerID, protocolParams.experimentName, [protocolParams.todayDate, '_', protocolParams.sessionName], sprintf('videoFiles_acquisition_%02d',protocolParams.acquisitionNumber));
