...
if ~(protocolParams.simulate.radiometer)
    ...
    %if MaxMelPassStatus == 0
        OLCorrectDirection_Squint(MaxMelDirection, MaxMelBackground, ol, radiometer);
   ...
   % end
    ...
    %if MaxLMSPassStatus == 0
        OLCorrectDirection_Squint(MaxLMSDirection, MaxLMSBackground, ol, radiometer);
    ...
    %if LightFluxPassStatus == 0
        OLCorrectDirection_Squint(LightFluxDirection, LightFluxBackground, ol, radiometer);
