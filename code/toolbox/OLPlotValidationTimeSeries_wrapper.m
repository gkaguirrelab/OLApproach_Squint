...
calibrations = {'2018-05-29', '2018-07-11', '2018-09-05'}; % when relevant calibrations happened. 2018-05-29 -> when we switched form ND 0.4 to 0.3. 2018-07-11 -> when we switched from ND 0.3 to 0.2.
...
'visualizedStatistics', 'medians and data points', ...
'excludedSubjectNames', excludedSubjectNames, ...
'yLim', [3.75 4.25], 'limits', [3.75 4.25], 'calibrations', calibrations, 'saveDir', saveDir, 'firstDateToPlot', firstDateToPlot, 'excludedSessions', excludedSessions  ...
);
