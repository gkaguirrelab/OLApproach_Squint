...
calibrations = {'2018-05-29', '2018-07-11', '2018-09-05', '2018-10-10', '2018-11-13', '2018-12-06', '2019-02-15', '2019-02-20', '2019-03-19', '2019-03-29', '2019-04-26', '2019-06-27'}; % when relevant calibrations happened. 2018-05-29 -> when we switched form ND 0.4 to 0.3. 2018-07-11 -> when we switched from ND 0.3 to 0.2.
...
[ chromaticityAccumulator ] = summarizeChromaticity(sessionList);
print(plotFig, fullfile(saveDir, 'chromaticity.pdf'), '-dpdf', '-fillpage');
